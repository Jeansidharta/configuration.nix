...
buildGoModule {
  ...
  src = fetchFromGitHub {
    owner = "encodeous";
    repo = "nylon";
    rev = "c350af0af4c613f43bb659182e2b7589d02626fe";
    hash = "sha256-Wvfifw+ztp91tcgsV/ubhBL5Q9mVQyq/v+jwhIIM6Q4=";
  };

  vendorHash = "sha256-vGEIdncKMzPliNQ+QPELJYBa3P/aOId8xzAx4LxjUGs=";
