# Copied from https://github.com/nix-community/home-manager/blob/master/modules/programs/yazi.nix
{ config, lib, pkgs, ... }:

with lib;

let
  cfg = config.programs.yazi-custom;
...
in {
  ...
  config = mkIf cfg.enable {
    ...
    programs.zsh.initContent = mkIf cfg.enableZshIntegration bashIntegration;
