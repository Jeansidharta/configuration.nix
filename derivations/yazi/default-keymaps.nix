# The default Yazi keybinds. This is because when defining custom keybinds through Nix,
# it overrides all defaults, making the program unusable. Therefore, I copied the
# defaults here, and transformed it into a nix object. This will cause it to
# merge with any custom keybing I define.
#
# The defaults were extracted from here:
